...
* https://groovyconsole.dev[Spock in the Groovy web console]
...
* https://fosstodon.org/@spockframework[Spock on Mastodon]
* https://bsky.app/profile/spockframework.org[Spock on Bluesky]
* https://x.com/SpockFramework[Spock on Twitter]
